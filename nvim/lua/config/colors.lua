vim.api.nvim_create_autocmd("ColorScheme", {
  ...
  callback = function()
    ...
    vim.api.nvim_set_hl(0, "@neorg.headings.2.title.norg", { fg = palette.theme.syn.identifier, bold = true })
    vim.api.nvim_set_hl(0, "@neorg.headings.3.title.norg", { fg = palette.theme.syn.statement, bold = true })
    ...
    vim.api.nvim_set_hl(0, "@neorg.headings.2.prefix", { fg = palette.theme.syn.identifier, bold = true })
    vim.api.nvim_set_hl(0, "@neorg.headings.3.prefix", { fg = palette.theme.syn.statement, bold = true })
