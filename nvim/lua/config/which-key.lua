...
wk.add({
  ...
  { "<leader>oT", function() require('orgmode').action('org_mappings.org_babel_tangle', true) end, desc = "org tangle" },
  ...
  { "<leader>fO", function() require'telescope'.extensions.orgmode.refile_heading() end, desc = "refile heading" },
  { "<leader>fl", function() require'telescope'.extensions.orgmode.insert_link() end, desc = "insert link" },
